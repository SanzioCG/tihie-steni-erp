        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-300">
            <thead className="bg-white/5 text-primary border-b border-white/5">
              <tr>
                <th className="px-6 py-4 text-[9px] font-black uppercase text-center w-16">#</th>
                <th className="px-6 py-4 text-[9px] font-black uppercase">{t('batch')}</th>
                <th className="px-6 py-4 text-[9px] font-black uppercase">{t('image')}</th>
                <th className="px-6 py-4 text-[9px] font-black text-center">{t('sku')}</th>
                <th className="px-6 py-4 text-[9px] font-black text-center">{t('category')}</th>
                <th className="px-6 py-4 text-[9px] font-black">{t('series_name')}</th>
                <th className="px-6 py-4 text-[9px] font-black text-center">{t('size')}</th>
                <th className="px-6 py-4 text-[9px] font-black text-center">{t('qoldiq')}</th>
                <th className="px-6 py-4 text-[9px] font-black text-right">{t('tan_narx')}</th>
                <th className="px-6 py-4 text-[9px] font-black text-right">{t('sotuv_narxi')}</th>
                <th className="px-6 py-4 text-[9px] font-black text-center">{t('actions')}</th>
              </tr>
            </thead>
              ...
              {stocks.map((batch: any, index: number) => {
                ...
                return (
                  <tr key={batch.id} className="group hover:bg-white/1 transition-all text-white font-medium">
                    ...
                    <td className="px-6 py-2.5 font-mono text-sm font-black text-gray-400">{batch.batch_number}</td>
                    ...
                    <td className="px-6 py-2.5 text-center font-mono text-[10px] text-gray-500 uppercase">{batch.products?.sku}</td>
                    <td className="px-6 py-2.5 text-center font-black text-[10px] uppercase text-primary/70">{batch.products?.categories?.name_uz}</td>
                    <td className="px-6 py-2.5">
                    ...
                    <td className="px-6 py-2.5 text-right font-black text-emerald-400 font-mono text-base">{convert(batch.purchase_price)}</td>
                    <td className="px-6 py-2.5 text-right font-black text-primary font-mono text-base">{convert(batch.selling_price)}</td>
                    <td className="px-6 py-2.5 text-center">
